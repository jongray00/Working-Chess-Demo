...
import Video from "../../connection/signalwire_video";
...
const ChessGameWrapper = (props) => {
    ...
    const domainName = 'https://fae0abd80acb.ngrok.io'
      ...
      <React.Fragment>
        {opponentDidJoinTheGame ? (
          ...
          <div>
            ...
            <textarea
              style={{ marginLeft: String((window.innerWidth / 2) - 290) + "px", marginTop: "30" + "px", width: "700px", height: "30px"}}
              onFocus={(event) => {
                  console.log('sd')
                  event.target.select()
              }}
